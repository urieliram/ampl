...
!                                                                         *
!     Propósito:                                                          *
!         Declaración de variables necesarios para el programa CHT-AU-AUHE*
!                                                                         *
...
!Potencia de generación de una unidad no programable
...
!Costo de arranque único de una unidad de rango continuo
...
!Número de bloques de arranque para unidades de rango continuo
...
! Cálculo oferta de reserva rodante de diez minutos unidades de rango continuo
common / CalOferResR10RC  / CalOferResR10RC  ( maxurc, maxint )

! Cálculo oferta de reserva rodante de diez minutos unidades de rango discontinuo
common / CalOferResR10RD  / CalOferResR10RD  ( maxurd, maxmodos, maxint )

! Cálculo oferta de reserva rodante suplementaria unidades de rango continuo
common / CalOferResRxRC  / CalOferResRxRC  ( maxurc, maxint )

! Cálculo oferta de reserva rodante suplementaria unidades de rango discontinuo
common / CalOferResRxRD  / CalOferResRxRD  ( maxurd, maxmodos, maxint )

! Cálculo oferta de reserva de regulacion secundaria unidades de rango continuo
common / CalOferResRegRC  / CalOferResRegRC  ( maxurc, maxint )

! Cálculo oferta de reserva de regulacion secundaria unidades de rango continuo con bandas prohibidas
...
! Cálculo del limite minimo de la oferta de reserva no rodante de diez minutos unidades de rango continuo
common / CalOferResNR10RC  / CalOferResNR10RC  ( maxurc, maxint )

! Cálculo del limite minimo de la oferta de reserva no rodante de diez minutos unidades de rango discontinuo
common / CalOferResNR10RD  / CalOferResNR10RD  ( maxurd, maxmodos, maxint )

! Cálculo del limite minimo de la oferta de reserva no rodante suplementaria unidades de rango continuo
common / CalOferResNRxRC  / CalOferResNRxRC  ( maxurc, maxint )

! Cálculo del limite minimo de la oferta de reserva no rodante suplementaria unidades de rango discontinuo
common / CalOferResNRxRD  / CalOferResNRxRD  ( maxurd, maxmodos, maxint )

! Cálculo del limite minimo de la oferta de reserva no rodante de diez minutos unidades hidro
common / CalOferResNR10H  / CalOferResNR10H  ( maxurc, maxint )

! Cálculo del limite minimo de la oferta de reserva no rodante suplementaria unidades hidro
...
! Cálculo oferta de reserva rodante de diez minutos unidades hidro
common / CalOferResR10H  / CalOferResR10H  ( maxuh, maxint )

! Cálculo oferta de reserva rodante suplementaria unidades hidro
common / CalOferResRxH  / CalOferResRxH  ( maxuh, maxint )

! Cálculo oferta de reserva de regulacion secundaria unidades hidro
...
! Grupos con limitación de energía a las que pertenecen las unidades de rango continuo
...
! Resultados de costos marginales por región
common / Unipmr / Unipmr

! Resultados de costos marginales por región término de balance de energía
common / Unipmrgen / Unipmrgen

! Resultados de costos marginales por región término de pérdidas
common / Unipmrper / Unipmrper

! Resultados de costos marginales por región término de congestión
common / Unipmrcon / Unipmrcon

! Resultados de costos marginales por nodo
common / Unilmp / Unilmp

! Resultados de costos marginales por nodo término de balance de energía
common / Unilmpgen / Unilmpgen

! Resultados de costos marginales por nodo término de pérdidas
common / Unilmpper / Unilmpper

! Resultados de costos marginales por nodo término de congestión
...
!	Lista de generadores por compañia, Col. 1: Compra, Col. 2: Venta 
...
! Alerta en definición de limites de regulacion de unidades de rango continuo
integer alertaregRC
common / alertaregRC / alertaregRC ( maxurc, maxint )

! Alerta en definición de limites de regulacion de unidades de rango discontinuo
integer alertaregRD
common / alertaregRD / alertaregRD ( maxurd, maxint )

! Alerta en definición de limites de regulacion de unidades hidro
integer alertaregUH
